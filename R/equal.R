...
#' @export
vec_equal_template2_no_alias <- function(x, y, na_equal = FALSE, .ptype = NULL) {
  .Call(vctrs_equal_template2_no_alias, x, y, na_equal)
}
